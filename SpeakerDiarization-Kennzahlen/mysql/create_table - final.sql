CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`session` (
...
CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`speaker` (
...
CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`session_speaker` (
  ...
  CONSTRAINT `id_session`
    ...
    REFERENCES `speaker-diarization-kpi`.`session` (`idSession`),
  CONSTRAINT `id_speaker`
    FOREIGN KEY (`id_speaker`)
    REFERENCES `speaker-diarization-kpi`.`speaker` (`idspeaker`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`speaker_timeline` (
...
CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`speech` (
...
CREATE TABLE IF NOT EXISTS `speaker-diarization-kpi`.`speaker_speech` (
  `id_speaker` INT NULL DEFAULT NULL,
  ...
  CONSTRAINT `id_speech`
    ...
    REFERENCES `speaker-diarization-kpi`.`speech` (`idspeech`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;