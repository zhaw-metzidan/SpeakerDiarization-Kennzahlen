CREATE TABLE IF NOT EXISTS `inselspiel3`.`session` (
...
CREATE TABLE IF NOT EXISTS `inselspiel3`.`speaker` (
...
CREATE TABLE IF NOT EXISTS `inselspiel3`.`session_speaker` (
  ...
  CONSTRAINT `id_session`
    ...
    REFERENCES `inselspiel3`.`session` (`idSession`),
  CONSTRAINT `id_speaker`
    FOREIGN KEY (`id_speaker`)
    REFERENCES `inselspiel3`.`speaker` (`idspeaker`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;

CREATE TABLE IF NOT EXISTS `inselspiel3`.`speaker_timeline` (
...
CREATE TABLE IF NOT EXISTS `inselspiel3`.`speech` (
...
CREATE TABLE IF NOT EXISTS `inselspiel3`.`speaker_speech` (
  `id_speaker` INT NULL DEFAULT NULL,
  ...
  CONSTRAINT `id_speech`
    ...
    REFERENCES `inselspiel3`.`speech` (`idspeech`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;